    ...
    return (
      <section className="max-w-3xl mx-auto">
        ...
        <CalculatorHeader
          ...
          description="Use this BMI calculator to calculate your Body Mass Index and check whether your weight falls within a healthy range."
        />
  ...
  <p>
    BMI (Body Mass Index) is a numerical value calculated from a person's height
    and weight. It helps classify individuals into weight categories such as
    underweight, normal weight, overweight, and obese.
  </p>

  <p>
    This BMI calculator follows the World Health Organization (WHO) guidelines
    and provides a quick screening method to assess potential health risks
    related to body weight.
  </p>

  <p>
    While BMI is widely used, it should be combined with other health indicators
    such as waist circumference, body fat percentage, and lifestyle factors for
